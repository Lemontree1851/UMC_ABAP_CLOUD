...
define view entity ZI_BI003_REPORT_002_BILLING_F4
  with parameters
    p_recover_type   : ze_recycle_type,
    p_condition_type : kscha
  as select from    I_BillingDocumentItem          as billingitem
    inner join      ZR_TBI_RECY_INFO001            as recover_info  on  billingitem.YY1_ManagementNo_2_BDI = recover_info.RecoveryManagementNumber
