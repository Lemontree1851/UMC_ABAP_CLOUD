...
@EndUserText.label: 'Comsuption View for ZI_BI003_003 Job Saved Data'
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
define root view entity ZC_BI003_REPORT_003_JOB
  provider contract transactional_query
  as projection on ZI_BI003_REPORT_003_JOB
{
  key PurchaseOrder,
