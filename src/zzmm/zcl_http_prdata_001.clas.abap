...
*        ARRANGE_START_DATE              type  c  length  8    ,
        ...
        m_r_p_controller       TYPE i_mrpcontroller-mrpcontroller,     " ADD BY XINLEI XU 2025/03/25 CR#4293
        m_r_p_controller_name  TYPE i_mrpcontroller-mrpcontrollername, " ADD BY XINLEI XU 2025/03/31 CR#4293
      END OF ty_response,
      BEGIN OF ty_output,
...
*    lv_pre_month+6(2) = '01'.
    ...
    TRY.
        SELECT a~purchaserequisition,
               ...
               h~mrpcontrollername " ADD BY XINLEI XU 2025/03/31 CR#4293
          ...
          LEFT JOIN i_productplantbasic WITH PRIVILEGED ACCESS AS g ON g~product = a~material
                                                                   AND g~plant = a~plant
          LEFT JOIN i_mrpcontroller WITH PRIVILEGED ACCESS AS h ON h~mrpcontroller = a~mrpcontroller " ADD BY XINLEI XU 2025/03/31 CR#4293
...
*&--ADD END BY XINLEI XU 2025/03/26 CR#4293
            ...
            ls_response-m_r_p_controller_name = lw_pr-mrpcontrollername. " ADD BY XINLEI XU 2025/03/31 CR#4293
