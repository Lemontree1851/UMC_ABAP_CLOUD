  ...
  as projection on ZR_TMM_1006
{
  key     UUID,
          ...
          _UserEmail.Email as CreatedByUserEmail,
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_GET_MM1006_DATA'
          @Consumption.filter.hidden: true
  virtual CostCenterName : abap.char(20),
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_GET_MM1006_DATA'
          @Consumption.filter.hidden: true
  virtual GLAccountName  : abap.char(20),
