...
CLASS ZCL_MFGORDER_002 IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA:
      ...
      lr_companycode_auth            TYPE RANGE OF zc_mfgorder_002-companycode,
...
******Add start 20250423**********************************************
      SELECT *
       ...
       WHERE companycode in @lr_companycode
        ...
        INTO TABLE @DATA(lt_1021).

      LOOP AT lt_1021 INTO DATA(ls_1021).
        MOVE-CORRESPONDING ls_1021 TO ls_mfgorder_002.
        ls_mfgorder_002-soldtoparty = |{ ls_mfgorder_002-soldtoparty ALPHA = OUT }|.
        ls_mfgorder_002-product = zzcl_common_utils=>conversion_matn1(
                                     EXPORTING iv_alpha = 'OUT'
                                               iv_input = ls_mfgorder_002-product ).
        APPEND ls_mfgorder_002 TO lt_mfgorder_002.
