                                                       ...
                                                       and _UserCompany.UserID = $session.user 
{
  ...
  key A.ValidityEndDate,
      ...
      //   }
      A._FixedAsset.AssetAdditionalDescription as LeasedAssetNote, //⑪追記テキスト
      @UI:{
      ...
      case A._FixedAsset.YY1_fixedasset2_FAA
      when '50' then 'イニシャル'
      else ''
      end                                      as InvestmentReason,
      ...
      case A._FixedAsset.YY1_fixedasset1_FAA
      when '01' then '所有'
      when '02' then '借家'
      else ''
      end                                      as YY1_FIXEDASSET1_FAA,
      @UI.hidden: true
      @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_FIXEDASSET_CAL'
